...
#        self.network.add(Dense(512, input_dim=STATE_SIZE, activation='relu'))
#        self.network.add(Dense(256, input_dim=STATE_SIZE, activation='linear'))
#        self.network.add(Dense(128, input_dim=STATE_SIZE, activation='linear'))
#        self.network.add(Dense(64, input_dim=STATE_SIZE, activation='linear'))
#        self.network.add(Dense(32, input_dim=STATE_SIZE, activation='linear'))
